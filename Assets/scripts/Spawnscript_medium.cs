...
public class Spawnscript_medium : MonoBehaviour
{
    ...
    IEnumerator StartSpawing()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            System.Random rnd = new System.Random();// we are creating random numbers from 0 to 9
            int number = rnd.Next(0, 10);   // 0 is min. and 9 is max, but is counts from 0 to 9 and it neglects 9(max.) 
